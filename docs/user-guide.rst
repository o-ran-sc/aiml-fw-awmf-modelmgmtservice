...
#. Registering a model in Model Management Service
   ...
   .. code:: bash
        ...
        curl  -i  -H "Content-Type: application/json"  \
                ...
                http://127.0.0.1:8082/registerModel
...
#. Fetch trained model information from Model Management Service
   ...
   .. code:: bash
        ...
        curl -X GET  http://127.0.0.1:8082/getModelInfo/qos_301

#. Upload a trained AIML Model to Model Management Service

   .. code:: bash

        curl -F "file=@<MODEL_ZIP_FILE_NAME>" http://127.0.0.1:8082/uploadModel/qos_301

#. Download a trained model from Model Management Service

   .. code:: bash

        curl -X GET http://127.0.0.1:8082/downloadModel/qos_301/model.zip --output model.zip
